...
function Navbar() {
    ...
    return (
        <div className="font-primary flex justify-between navbar sticky border-b border-gray-200 top-0 bg-white h-16 md:h-24 md:px-40 px-8 items-center z-50">
            ...
            <ul className="flex w-full -ml-8 md:w-96 justify-evenly p-4 md:p-0 hidden absolute top-16 md:relative md:top-0 gap-8  md:flex transition ease-in-out duration-1000 bg-white"  id="menu">
