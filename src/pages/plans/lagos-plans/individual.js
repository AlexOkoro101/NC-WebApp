...
function IndividualLagos() {
    ...
    const getPlanDetails = () => {
        ...
        fetch(process.env.REACT_APP_BASE_URL + "plans?insurer=5", requestOptions)
                                    ...
                                    <div className="md:max-w-none bg-white px-8 md:px-5 py-8 md:py-0 mb-3 mx-0 md:-mx-3 md:mb-0 md:relative md:flex md:flex-col lg:border-l lg:h-32 lg:border-t-0 border-t">
                                        <div className="w-full flex-grow">
                                            ...
                                            <ul className="text-xs mb-8 plan-detail flex flex-wrap gap-x-4">
                                                ...
                                                <li className="leading-tight items-center flex mb-2 gap-x-1"><svg className="w-6 h-6" fill="none" stroke={planBenefits?.specialist_consultation ? "#00B252" : "#f00"} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={planBenefits?.specialist_consultation ? "M5 13l4 4L19 7" : "M6 18L18 6M6 6l12 12"}></path></svg> <span>Specialist Consultation</span> </li>
                                ...
                                <div>
                                    ...
                                    <table className="table-fixed w-full md:hidden block bg-white">
                                        <tbody className="w-full table">
                                            ...
                                            <tr>
                                                <td className="p-4 border border-gray-200" colSpan="3"><span className="color-primary font-semibold md:text-lg text-base">Price</span>  <br /> <span className="text-black font-medium text-lg">N{dependentArray.length >= 1 ? (dependentArray.length + 1) * Number(planAmount) : planAmount}</span> </td>
                                            </tr>
                                    ...
                                    <table className="table-fixed w-full hidden md:block bg-white">
                                        <tbody className="w-full table">
                                            ...
                                            <tr>
                                                <td className="p-4 border border-gray-200" colSpan="3"><span className="color-primary font-semibold md:text-base text-sm">Price</span>  <br /> <span className="text-black font-medium text-lg">N{dependentArray.length >= 1 ? (dependentArray.length + 1) * Number(planAmount) : planAmount}</span> </td>
                                            </tr>
